...
# this is a complicated file, in here some stuff seems to be the same as the giuliac device while others are different. 
# this is a real trial and error i think
namespace_imports = [
    'hardware/oplus',
